...
IF (lateralVelocity IS NOT ZERO) THEN acceleration IS low
			...
			Indien men dit in een exacte controller wil implementeren, moeten de twee regels gemultiplexd worden in \'e\'en formule. Dit kan bijvoorbeeld als volgt gebeuren. %% gemultiplexed?
